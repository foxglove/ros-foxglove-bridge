 ...
 * __use_compression__: Use websocket compression (permessage-deflate). It is recommended to leave this turned off as messages of subscribed topics are transferred in binary form for which compression is ineffective. Defaults to `false`.

...
protected:
  MessageTypeSupport::ConstSharedPtr getMessageTypeSupportImpl(
    const std::string& type) const override;

  ServiceTypeSupport::ConstSharedPtr getServiceTypeSupportImpl(
    const std::string& type) const override;

  ActionTypeSupport::ConstSharedPtr getActionTypeSupportImpl(
    const std::string& type) const override;
};
}  // namespace ros2_babel_fish
